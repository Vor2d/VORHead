...
public class ToReset : StateMachineBehaviour {
    ...
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        GC_script.Current_state = "ToReset";

        GC_script.ToReset();
        GC_script.update_SS();
        JLS_script.log_action(GC_script.simulink_sample,GC_script.trial_iter,"ReSet",0.0f,0);
    }
