...
public static class FS_SD
{
    ...
    public const string AniToggle_str = "Toggle";
    public const string AniShowPanel_str = "ShowPanel";
    public const string AniSelect_str = "Select";
    //Input;
    ...
    //Layers;
    public const string SortingLayer_GO = "GameObject";
    //Objects;
